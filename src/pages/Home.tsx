...
import { Search, MapPin, Calendar, Clock, CreditCard, CheckCircle2, Star, Zap, Smartphone, CreditCard as CardIcon, ChevronRight, ArrowLeft, Filter, SlidersHorizontal, ShieldCheck, Coffee, Wifi, TrendingUp, Quote, Navigation } from 'lucide-react';
...
export default function Home({ userProfile }: HomeProps) {
  ...
  const handleBooking = async () => {
    if (!userProfile || !selectedTrip) return;
    ...
    try {
      ...
      // Notify admins (simplified for SQLite demo)
      // In a real app, you'd fetch admin subscriptions from the DB
            ...
            <section className="relative h-[600px] rounded-[4rem] overflow-hidden flex items-center justify-center text-center p-6">
              ...
              <div className="relative z-10 max-w-3xl space-y-8">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 bg-black/40 backdrop-blur-2xl p-4 rounded-[2.5rem] border border-white/10 shadow-2xl">
                  ...
                  <button className="w-full md:w-auto bg-emerald-600 text-white px-12 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-500 transition-all shadow-xl shadow-emerald-600/20 active:scale-95">
                    بحث الآن
                  </button>
                </div>
              </div>
        ...
        {bookingStep === 'payment' && selectedTrip && (
          ...
          >
            ...
            <button
              ...
              className="w-full bg-emerald-600 text-white py-6 rounded-3xl font-black text-lg uppercase tracking-[0.2em] hover:bg-emerald-500 transition-all disabled:opacity-20 shadow-2xl shadow-emerald-600/40"
            >
