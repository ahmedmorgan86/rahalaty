...
import { Plus, Trash2, Edit, Bus as BusIcon, MapPin, Calendar, DollarSign, Users, TrendingUp, Star, LayoutDashboard, Settings, LogOut, Bell, BarChart3, PieChart as PieChartIcon, MessageSquare, CheckCircle2, Send, Zap, Image as ImageIcon, Eye, Wrench, History, AlertTriangle, Navigation } from 'lucide-react';
...
export default function Admin() {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'trips' | 'buses' | 'support'>('dashboard');
  ...
  useEffect(() => {
    ...
    // Poll for chats (since SQLite doesn't have real-time listeners like Firestore)
